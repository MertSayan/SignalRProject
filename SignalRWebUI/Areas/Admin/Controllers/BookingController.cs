...
namespace SignalRWebUI.Areas.Admin.Controllers
{
	...
	public class BookingController : Controller
	{
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync("https://localhost:7155/api/Bookings/UpdateBookingStatusApproved?id="+id);
			return RedirectToAction("Index", "Booking", new { area = "Admin" });
		}
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync("https://localhost:7155/api/Bookings/UpdateBookingStatusCancelled?id=" + id);
			return RedirectToAction("Index", "Booking", new { area = "Admin" });
		}
	}
}
